...
This site inherits Paul Brown's portable design system. See the canonical Field Guide in [Field Guide](https://github.com/browningtons/field-guide/blob/main/field-guide.md) for the system in full. This doc is the per-app surface: palette, persona, three questions, hero outcome.
...
The following come from the canonical Field Guide and are not relitigated here. See [Field Guide](https://github.com/browningtons/field-guide/blob/main/field-guide.md) for the full text:
